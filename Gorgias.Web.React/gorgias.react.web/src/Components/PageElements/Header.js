...
export default class Header extends React.Component {
    ...
    componentDidMount() {
        this.prepareMenu();
        console.log('it did mount yoho');
        console.log(window.location.pathname, 'i am here ;)', 'componentDidMount');
    ...
    prepareMenu = () =>{
        ...
        // this.setState({prepareMenu: true});
    }
    ...
    prepareNavBar() {
        console.log('prepareNavBar yoho', this.state.typeOfNavBar);
                                        ...
                                        <nav id="menu" className="menu-main-menu-container">
                                            {this.state.isMainPage ?
                                                <ul id="menu-main-menu" className="menu tk">
                                                    ...
                                                    <li>
                                                        <a href="#Stories" className="close"><span>Stories</span></a>
                                                    </li>
                                                    {/*<li>
